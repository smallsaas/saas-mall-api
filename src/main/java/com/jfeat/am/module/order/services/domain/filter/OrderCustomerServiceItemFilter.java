 ...
 */
public class OrderCustomerServiceItemFilter implements CRUDFilter<OrderCustomerServiceItem> {

    private String[] ignoreFields = new String[]{};
    private String[] updateIgnoreFields = new String[]{};

    @Override
    public void filter(OrderCustomerServiceItem entity, boolean insertOrUpdate) {
