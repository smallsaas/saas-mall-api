 ...
 */
public class OrderCustomerServiceFilter implements CRUDFilter<OrderCustomerService> {

    private String[] ignoreFields = new String[]{};
    private String[] updateIgnoreFields = new String[]{};

    @Override
    public void filter(OrderCustomerService entity, boolean insertOrUpdate) {
