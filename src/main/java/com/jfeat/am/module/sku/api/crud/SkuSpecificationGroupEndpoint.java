...
import com.jfeat.am.module.sku.services.domain.model.CategorySpecModelFront;
...
public class SkuSpecificationGroupEndpoint extends BaseController {
    ...
    public Tip createSpecificationGroup(@RequestBody CategorySpecModelFront entity) {
    ...
    public Tip updateSpecificationGroup(@PathVariable Long id, @RequestBody CategorySpecModelFront entity) {
        entity.setId(id);
    ...
    @BusinessLog(name = "FrontProductCategory", value = "delete FrontProductCategory")
    ...
    @BusinessLog(name = "FrontProductCategory", value = "delete Specification Group")
