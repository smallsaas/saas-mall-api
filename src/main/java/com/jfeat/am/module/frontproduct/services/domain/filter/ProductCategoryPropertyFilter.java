 ...
 */
public class ProductCategoryPropertyFilter implements CRUDFilter<ProductCategoryProperty> {

    private String[] ignoreFields = new String[]{};
    private String[] updateIgnoreFields = new String[]{};

    @Override
    public void filter(ProductCategoryProperty entity, boolean insertOrUpdate) {
