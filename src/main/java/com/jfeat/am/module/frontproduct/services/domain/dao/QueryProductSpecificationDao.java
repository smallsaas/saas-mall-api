 ...
 */
public interface QueryProductSpecificationDao extends BaseMapper<ProductSpecification> {
    List<ProductSpecificationRecord> findProductSpecificationPage(Page<ProductSpecificationRecord> page, @Param("record") ProductSpecificationRecord record,
