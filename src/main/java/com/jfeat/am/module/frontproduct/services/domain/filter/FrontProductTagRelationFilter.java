 ...
 */
public class FrontProductTagRelationFilter implements CRUDFilter<FrontProductTagRelation> {

    private String[] ignoreFields = new String[]{};
    private String[] updateIgnoreFields = new String[]{};

    @Override
    public void filter(FrontProductTagRelation entity, boolean insertOrUpdate) {
