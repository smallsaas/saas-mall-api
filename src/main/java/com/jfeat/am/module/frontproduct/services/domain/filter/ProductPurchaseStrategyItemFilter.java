 ...
 */
public class ProductPurchaseStrategyItemFilter implements CRUDFilter<ProductPurchaseStrategyItem> {

    private String[] ignoreFields = new String[]{};
    private String[] updateIgnoreFields = new String[]{};

    @Override
    public void filter(ProductPurchaseStrategyItem entity, boolean insertOrUpdate) {
