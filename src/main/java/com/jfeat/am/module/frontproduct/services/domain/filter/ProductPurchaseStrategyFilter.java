 ...
 */
public class ProductPurchaseStrategyFilter implements CRUDFilter<ProductPurchaseStrategy> {

    private String[] ignoreFields = new String[]{};
    private String[] updateIgnoreFields = new String[]{};

    @Override
    public void filter(ProductPurchaseStrategy entity, boolean insertOrUpdate) {
