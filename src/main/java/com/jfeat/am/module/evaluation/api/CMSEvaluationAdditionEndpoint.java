...
public class CMSEvaluationAdditionEndpoint extends BaseController {
    ...
    public Tip createStockEvaluationAddition(@PathVariable Long evaluationId, @RequestBody StockEvaluationAdditionModel entity) {
        if (stockEvaluationService.retrieveMaster(evaluationId).getMemberId().compareTo(JWTKit.getUserId(getHttpServletRequest()))==0 ||
