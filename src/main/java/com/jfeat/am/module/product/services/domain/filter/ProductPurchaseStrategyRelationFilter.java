 ...
 */
public class ProductPurchaseStrategyRelationFilter implements CRUDFilter<ProductPurchaseStrategyRelation> {

    private String[] ignoreFields = new String[]{};
    private String[] updateIgnoreFields = new String[]{};

    @Override
    public void filter(ProductPurchaseStrategyRelation entity, boolean insertOrUpdate) {
