 ...
 */
public class ProductSettlementProportionFilter implements CRUDFilter<ProductSettlementProportion> {

    private String[] ignoreFields = new String[]{};
    private String[] updateIgnoreFields = new String[]{};

    @Override
    public void filter(ProductSettlementProportion entity, boolean insertOrUpdate) {
