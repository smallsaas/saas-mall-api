 ...
 */
public class ProductSpecificationFilter implements CRUDFilter<ProductSpecification> {

    private String[] ignoreFields = new String[]{};
    private String[] updateIgnoreFields = new String[]{};

    @Override
    public void filter(ProductSpecification entity, boolean insertOrUpdate) {
