...
INSERT INTO `t_config` VALUES (54, NULL, 4, '分区1名称', 'frontproduct.partner_level_zone_1', 'String', '零元区', '', 1, '分区1名称',0,NULL);
INSERT INTO `t_config` VALUES (55, NULL, 4, '分区2名称', 'frontproduct.partner_level_zone_2', 'String', '精品区', '', 1, '分区1名称',0,NULL);
INSERT INTO `t_config` VALUES (56, NULL, 4, '分区3名称', 'frontproduct.partner_level_zone_3', 'String', '特价区', '', 1, '分区1名称',0,NULL);
INSERT INTO `t_config` VALUES (57, NULL, 4, '显示分成设置开关', 'frontproduct.show_settlement_setting', 'boolean', 'false', '', 1, '显示分成设置',0,NULL);
...
INSERT INTO `t_config` VALUES (62, NULL, 4, '显示规格设置开关', 'frontproduct.show_specification_setting', 'boolean', 'false', '', 1, '显示规格设置开关',0,NULL);
