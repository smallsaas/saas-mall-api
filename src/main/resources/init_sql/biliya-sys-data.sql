...
CREATE TABLE `t_end_user` (
                              ...
                              `password` varchar(100) DEFAULT NULL COMMENT '密码MD5值',
                              `salt` varchar(45) DEFAULT NULL COMMENT '盐值',
                              `name` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '昵称',
                              `dob` datetime DEFAULT NULL COMMENT '生日',
                              `gender` smallint(6) DEFAULT NULL COMMENT '性别:0-男,1-女,2-保密',
                              `email` varchar(45) DEFAULT NULL COMMENT '邮箱',
                              `phone` varchar(45) DEFAULT NULL COMMENT '电话',
                              `invite_code` varchar(32) DEFAULT NULL COMMENT '专属邀请码',
                              `invitor_id` bigint(20) DEFAULT NULL COMMENT '邀请人id',
                              `status` int(11) DEFAULT '0' COMMENT '状态',
                              `team_count` int(12) DEFAULT '1' COMMENT '团队人数',
                              `create_time` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间，可理解为注册时间',
                              `version` int(11) DEFAULT NULL COMMENT '版本',
                              `delete_flag` int(11) NOT NULL DEFAULT '0' COMMENT '逻辑删除字段',
                              `registered_github_username` varchar(40) DEFAULT NULL COMMENT '注册的github用户名',
                              `registered_phone` varchar(20) DEFAULT NULL COMMENT '注册手机',
                              `registered_email` varchar(40) DEFAULT NULL COMMENT '注册EMAIL',
                              `email_validated` tinyint(4) NOT NULL DEFAULT '0' COMMENT '邮箱是否验证，默认 0-未验证,1-验证',
                              `phone_validated` tinyint(4) NOT NULL DEFAULT '0' COMMENT '电话是否验证，默认 0-未验证,1-验证',
                              `org_id` bigint(20) DEFAULT NULL COMMENT '部门 id ',
                              `tag` varchar(30) NOT NULL DEFAULT 'NORMAL' COMMENT '分类字段',
                              `category_tag` varchar(30) DEFAULT NULL COMMENT '分类字段2',
                              `is_compere` smallint(5) NOT NULL DEFAULT '0' COMMENT '是否是主持人，0否1是',
                              `is_register` smallint(5) NOT NULL DEFAULT '0' COMMENT '是否是注册用户，0否1是',
                              `type` int(11) DEFAULT '0' COMMENT '类型 1 普通用户 2供应商 3是租户 4房东 5中介 7是运维 8体验用户',
                              `sys_user_id` bigint(20) DEFAULT NULL COMMENT '关联系统用户id',
                              `vendor` varchar(40) DEFAULT NULL COMMENT '用户所属渠道',
                              `org_update_time` datetime DEFAULT NULL,
                              `property_consultant` tinyint(4) DEFAULT '0' COMMENT '是否是置业顾问 默认0不是 1-是',
                              `produce_team` varchar(50) DEFAULT NULL COMMENT '经济社',
                              `team_id` bigint(20) DEFAULT NULL,
                              `agent_id` bigint(20) DEFAULT NULL COMMENT '绑定代理',
                              `appid` varchar(50) DEFAULT NULL,
                              `current_org_id` bigint(20) DEFAULT NULL COMMENT '当前组织id',
                              `union_id` varchar(50) DEFAULT NULL COMMENT '唯一应用id',
                              `wx_code` varchar(50) DEFAULT NULL COMMENT '微信号',
                              `real_name` varchar(100) DEFAULT NULL,
                              `invitor_type` varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT '强弱绑定',
                              PRIMARY KEY (`id`) USING BTREE,
                              UNIQUE KEY `account` (`account`,`appid`) USING BTREE,
                              UNIQUE KEY `phone` (`phone`,`appid`) USING BTREE,
                              UNIQUE KEY `registered_phone` (`registered_phone`,`appid`) USING BTREE,
                              UNIQUE KEY `registered_email` (`registered_email`,`appid`) USING BTREE,
                              UNIQUE KEY `registered_github_username` (`registered_github_username`,`appid`) USING BTREE
